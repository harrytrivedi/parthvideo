<?php
$pageTitle = "My Account - Cryptoshow Society";
...
<div class="my-account-container"> <!-- Updated class name -->
    <div class="form-container">
        ...
        <button id="modeToggle" class="night-mode-buttonprof" onclick="toggleMode()"><i class="fa-solid fa-sun"></i>
            Light Mode </button>
        ...
        <form action="..//includes/update-profile.php" method="post" onsubmit="return confirmUpdate()">
        ...
        <form action="../includes/update-avatar.php" method="post" enctype="multipart/form-data"
        ...
        <form action="..//includes/delete-profile.php" method="post" onsubmit="return confirmDeletion()">
